...
if (isset($_POST['submit'])) {
  try {
    ...
    $sql_insert = '
      INSERT INTO books 
        (book_code, book_name, price, stock_quantity, genre_code) VALUES 
        (:book_code, :book_name, :price, :stock_quantity, :genre_code)
    ';
    ...
    <article class="registration">
      ...
      <form action="create.php" method="post" class="registration-form">
        <div>
          ...
          <input type="text" id="book_name" name="book_name" min="0" max="1000000000" required>

          <label for="price">単価</label>
          <input type="number" id="price" name="price" min="0" max="1000000000" required>
          ...
          <select name="genre_code" id="genre_code" required>
            ...
            foreach ($genre_codes as $genre_code) {
              echo "
                <option value='{$genre_code}'>{$genre_code}</option>
              ";
            }
            ?>
          </select>
